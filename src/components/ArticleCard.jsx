        ...
        <div className="flex justify-between flex-nowrap items-center mt-6 ">
          <div className="flex items-center gap-x-2 md:gap-x-2.5 ">
            ...
            <div className="flex flex-col">
              <h4 className="font-bold italic to-dark-soft text-sm md:text-base ">
                {post.user.name}
              </h4>
              <div className="flex items-center gap-x-2">
                ...
                >
                  {post.user.verified ? (
                    <FiCheck className="w-1.5 h-1.5 text-[#36B37E]" />
                  ) : (
                    <AiOutlineClose className="w-1.5 h-1.5 text-[#f7583c]" />
                  )}
                </span>
                <span className="italic to-dark-light text-xs md:text-sm">
