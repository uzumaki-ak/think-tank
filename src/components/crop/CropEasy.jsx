      ...
      <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
        ...
        <div className="flex justify-between gap-2 flex-wrap">
          ...
          disabled={isloading}
            ...
            className="px-5 py-2.5 rounded-lg text-rose-500 border border-red-500 text-sm disabled:opacity-70 "
          >
            Cancel
          </button>
          <button
           disabled={isloading}
            ...
            className="px-5 py-2.5 rounded-lg text-sky-100 bg-blue-600 text-sm disabled:opacity-70 "
          >
            Crop & Upload
          </button>
        </div>
